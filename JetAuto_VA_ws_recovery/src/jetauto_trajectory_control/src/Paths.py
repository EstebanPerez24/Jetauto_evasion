...
class Paths:
    def __init__(self):
        self.trajectory_name = rospy.get_param('path_type', "lemniscate")
        ...
        if self.params is None:
            rospy.logerr("Parameters for {} not found. Check your YAML file.".format(self.trajectory_name))
    ...
    def compute_trajectory(self):
        if self.trajectory_name in self.trajectory_functions:
            ...
            raise ValueError("Unknown trajectory type: {}".format(self.trajectory_name))
    ...
    def spiral(self):
        ...
        print("\033[38;2;0;255;0mGenerated spiral trajectory: a: {} b: {} xc: {} yc: {} Ts: {} Tf: {}\033[0m".format(a, b, x_center, y_center, Ts, Tf))
    ...
    def ellipse(self):
        ...
        print("\033[38;2;0;255;0mGenerated ellipse trajectory: a: {} b: {} xc: {} yc: {} Ts: {} Tf: {}\033[0m".format(a, b, x_center, y_center, Ts, Tf))
    ...
    def lemniscate(self):
        ...
        print("\033[38;2;0;255;0mGenerated Lemniscate trajectory: a: {} b: {} xc: {} yc: {} Ts: {} Tf: {}\033[0m".format(a, b, x_center, y_center, Ts, Tf))
    ...
    def sine(self):
        ...
        print("\033[38;2;0;255;0mGenerated Sine trajectory: ampl: {} freq: {} xc: {} yc: {} Ts: {} Tf: {}\033[0m".format(amplitude, frequency, x_center, y_center, Ts, Tf))
    ...
    def rectangle(self, length = 6, width = 4, center = [0, 0]):
        ...
        #print(f"\033[38;2;0;255;0mGenerated Rectangle trajectory: L: {} w: {} xc: {x_center} yc: {y_center} Ts: {Ts} Tf: {Tf}\033[0m")
        print("\033[38;2;0;255;0mGenerated Recangle trajectory: L: {} W: {} xc: {} yc: {} Ts: {} Tf: {}\033[0m".format(length, width, x_center, y_center, Ts, Tf))
        theta = np.linspace(0, 0, int(len(t)))
        w = np.linspace(0, 0, int(len(t)))
